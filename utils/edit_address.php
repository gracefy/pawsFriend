<a href="../pawsfriend/success.php"></a>

<?php
session_start();
$user_id = $_SESSION['userinfo']['user_id'];
$order_id = $_SESSION['userinfo']['order_id'];
...
if (isset($_POST['submit'])) {
  ...
  if (count($errors) == 0) {
    ...
    if ($result) {
      header("Location:../pawsfriend/success.php?id=$order_id");
      exit;
    } else {
...
<body>
  <?php
  include '../pawsfriend/includes/header.php';
  ?>
  ...
  <?php
  include '../pawsfriend/includes/footer.php';
  ?>

  <script src="./assets/js/cart_qty.js"></script>
</body>
