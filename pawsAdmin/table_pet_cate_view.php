...
<body>
  ...
  <!-- create user table -->
  <div class="main">
    <h3>Pet Category Table</h3>
    <span class="add"><a href="add_pet_cate_view.php">Add <i class="fa-solid fa-plus"></i></a></span>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        $query = 'SELECT category_id, category_name, description, image_url FROM pet_category;';
        ...
        for ($i = $start; $i < $end && $i < count($data); $i++) {
          ...
          $str .= "<td><a href='./edit_pet_cate_view.php?category_id={$data[$i]['category_id']}'>Edit</a> | <a href='control/delete_pet_cate.php?category_id={$data[$i]['category_id']}'>Delete</a></td></tr>";
    ...
    echo pagination($current_page, $total_pages, 'table_pet_cate_view.php');
    echo "</div>";
